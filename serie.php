                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main col-md-8">
                            ...
                            <!-- page-title start -->
                            <!-- ================ -->
                            <h1 class="page-title">X Files</h1>
                            ...
                            <article class="blogpost temporada">
                                <div class="row grid-space-10">
                                    ...
                                    <div class="col-md-9">
                                        <header>
                                            <h2><a href="blog-post.html">Piloto</a></h2>
                                            <div class="post-info">
                            ...
                            <article class="blogpost temporada">
                                <div class="row grid-space-10">
                                    ...
                                    <div class="col-md-9">
                                        <header>
                                            <h2><a href="blog-post.html">Tecnología robada</a></h2>
                                            <div class="post-info">
                                                <span class="post-date">
                                                    <i class="icon-tag"></i>
                                                    Capítulo 2 
                            ...
                            <article class="blogpost temporada">
                                <div class="row grid-space-10">
                                    ...
                                    <div class="col-md-9">
                                        <header>
                                            <h2><a href="blog-post.html">Muertes en serie</a></h2>
                                            <div class="post-info">
                                                <span class="post-date">
                                                    <i class="icon-tag"></i>
                                                    Capítulo 3 
                            ...
                            <article class="blogpost temporada">
                                <div class="row grid-space-10">
                                    ...
                                    <div class="col-md-9">
                                        <header>
                                            <h2><a href="blog-post.html">El conducto</a></h2>
                                            <div class="post-info">
                                                <span class="post-date">
                                                    <i class="icon-tag"></i>
                                                    Capítulo 4 
